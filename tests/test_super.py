...
def test_withdraw_with_reward(
    ...
    assert token.balanceOf(accounts[2]) >= int(816750000000000000000)
    assert token.balanceOf(accounts[3]) >= (int(1000e18) - int(1000e18)/100)
    assert token.balanceOf(accounts[4]) >= int(692.99e18)
    assert token.balanceOf(accounts[5]) >= int(1013e18)
    ...
    super.deposit(int(10e18), int(1e18), sender=accounts[1])
