...
def test_register_staker_event_fires(deploy, accounts):
    deployer = deploy[0]
    stable = deploy[3]
    token = deploy[4]
    tokenA = deploy[5]
...
def test_unregister_staker_event_fires(deploy, accounts):
    deployer = deploy[0]
    stable = deploy[3]
    token = deploy[4]
    tokenA = deploy[5]
...
def test_reward_payout_event_fires(deploy, accounts):
    deployer = deploy[0]
    stable = deploy[3]
    token = deploy[4]
    tokenA = deploy[5]
...
def test_reward_payout_and_register_again_event_fires(deploy, accounts):
    deployer = deploy[0]
    stable = deploy[3]
    token = deploy[4]
    tokenA = deploy[5]
